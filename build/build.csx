...
AsyncStep publish = async () =>
{
    ...
    await Command.ExecuteAsync("nuget", $"sign {nupkgFile.FullName} -CertificateFingerprint {certificateThumbprint} -HashAlgorithm SHA256 -Verbosity detailed -Timestamper http://timestamp.digicert.com");
