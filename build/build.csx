...
AsyncStep createResourcesPR = async () =>
{
    ...
    await Command.ExecuteAsync("./gh", $"pr create --head --title \"{changesetMessage}\" --body \"Here is the latest resources that was generated by DIPS.Mobile.DesignTokens repository\"");
};
