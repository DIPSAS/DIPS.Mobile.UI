...
AsyncStep publish = async () =>
{
    ...
    await Command.ExecuteAsync("nuget", $"sign {nupkgFile.FullName} -HashAlgorithm SHA256 -CertificateFingerprint {certificateThumbprint} -Verbosity detailed -Timestamper http://timestamp.digicert.com");
