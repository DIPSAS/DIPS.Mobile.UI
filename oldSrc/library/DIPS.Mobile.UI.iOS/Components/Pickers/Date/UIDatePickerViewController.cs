...
namespace DIPS.Mobile.UI.iOS.Components.Pickers.Date
{
    internal class UIDatePickerViewController : UIViewController
    {
        ...
        private void AddTopArea(UIStackView stackView)
        {
            ...
            m_closeButton.ImageView.TintColor = Colors.GetColor(ColorName.color_neutral_50).ToUIColor();
        ...
        private void AddDatePicker(UIStackView stackView)
        {
            ...
            m_datePicker.TintColor = Colors.GetColor(ColorName.color_primary_90).ToUIColor();
        ...
        private void AddDoneButton(UIStackView stackView, UIDatePicker datePicker)
        {
            ...
            m_doneButton.BackgroundColor = Colors.GetColor(ColorName.color_primary_d_90).ToUIColor();
