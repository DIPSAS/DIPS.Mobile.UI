...
12. **SystemMessage fling**: Dismiss gestures for `SystemMessage` should be vertical-only. Do not translate or dismiss system messages horizontally; detect vertical intent and constrain the interaction to the Y axis.
