...
.method public static final contentDeepEquals([Ljava/lang/Object;[Ljava/lang/Object;)Z
    ...
    invoke-static {v7, v8}, Lkotlin/collections/ArraysKt;->contentDeepEquals([Ljava/lang/Object;[Ljava/lang/Object;)Z
    ...
    invoke-static {v7, v8}, Ljava/util/Arrays;->equals([S[S)Z
    ...
    invoke-static {v7, v8}, Ljava/util/Arrays;->equals([D[D)Z
    ...
    invoke-static {v7, v8}, Ljava/util/Arrays;->equals([Z[Z)Z
    ...
    .line 100
    :cond_d
    instance-of v7, v5, Lkotlin/UByteArray;

    if-eqz v7, :cond_e

    instance-of v7, v6, Lkotlin/UByteArray;
    ...
    check-cast v8, Lkotlin/UByteArray;

    invoke-virtual {v8}, Lkotlin/UByteArray;->unbox-impl()[B

    move-result-object v8

    invoke-static {v7, v8}, Lkotlin/collections/unsigned/UArraysKt;->contentEquals-kV0jMPg([B[B)Z
    ...
    .line 101
    :cond_e
    instance-of v7, v5, Lkotlin/UShortArray;

    if-eqz v7, :cond_f

    instance-of v7, v6, Lkotlin/UShortArray;
    ...
    check-cast v8, Lkotlin/UShortArray;

    invoke-virtual {v8}, Lkotlin/UShortArray;->unbox-impl()[S

    move-result-object v8

    invoke-static {v7, v8}, Lkotlin/collections/unsigned/UArraysKt;->contentEquals-FGO6Aew([S[S)Z
    ...
    .line 102
    :cond_f
    instance-of v7, v5, Lkotlin/UIntArray;

    if-eqz v7, :cond_10

    instance-of v7, v6, Lkotlin/UIntArray;
    ...
    check-cast v8, Lkotlin/UIntArray;

    invoke-virtual {v8}, Lkotlin/UIntArray;->unbox-impl()[I

    move-result-object v8

    invoke-static {v7, v8}, Lkotlin/collections/unsigned/UArraysKt;->contentEquals-KJPZfPQ([I[I)Z
    ...
    .line 103
    :cond_10
    instance-of v7, v5, Lkotlin/ULongArray;

    if-eqz v7, :cond_11

    instance-of v7, v6, Lkotlin/ULongArray;
    ...
    check-cast v8, Lkotlin/ULongArray;

    invoke-virtual {v8}, Lkotlin/ULongArray;->unbox-impl()[J

    move-result-object v8

    invoke-static {v7, v8}, Lkotlin/collections/unsigned/UArraysKt;->contentEquals-lec5QzE([J[J)Z
...
.method private static final contentDeepToStringInternal$ArraysKt__ArraysKt([Ljava/lang/Object;Ljava/lang/StringBuilder;Ljava/util/List;)V
    ...
    invoke-static {v4, p1, p2}, Lkotlin/collections/ArraysKt__ArraysKt;->contentDeepToStringInternal$ArraysKt__ArraysKt([Ljava/lang/Object;Ljava/lang/StringBuilder;Ljava/util/List;)V
    ...
    :cond_c
    invoke-static {v5}, Lkotlin/collections/unsigned/UArraysKt;->contentToString-2csIQuQ([B)Ljava/lang/String;
    ...
    :cond_e
    invoke-static {v5}, Lkotlin/collections/unsigned/UArraysKt;->contentToString-d-6D3K8([S)Ljava/lang/String;
    ...
    :cond_10
    invoke-static {v5}, Lkotlin/collections/unsigned/UArraysKt;->contentToString-XUkPCBk([I)Ljava/lang/String;
    ...
    :cond_12
    invoke-static {v5}, Lkotlin/collections/unsigned/UArraysKt;->contentToString-uLth9ew([J)Ljava/lang/String;
