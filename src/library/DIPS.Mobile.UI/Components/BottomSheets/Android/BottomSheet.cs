...
public partial class BottomSheet
{
    ...
    {
        if (Handler is not BottomSheetHandler handler) throw new InvalidOperationException("BottomSheet must be opened before calling PopToRootAsync.");
        handler.PopToRootNavigationContent(popped);
        return Task.CompletedTask;
    }
}
