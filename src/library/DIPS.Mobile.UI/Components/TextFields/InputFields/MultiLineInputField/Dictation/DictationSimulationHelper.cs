...
public static class DictationSimulationHelper
{
    ...
    public static async Task<StartDictationResult> StartDictationDelegateTest(IDictationConsumerDelegate consumerDelegate, 
