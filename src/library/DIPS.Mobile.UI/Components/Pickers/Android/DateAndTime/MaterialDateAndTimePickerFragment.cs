...
namespace DIPS.Mobile.UI.Components.Pickers.Android.DateAndTime;

public class MaterialDateAndTimePickerFragment
{
    private readonly DateAndTimePicker? m_datePicker;
    private readonly MaterialDatePicker m_materialDatePicker;

    private const string DatePickerTag = "DUIMaterialDateTimePicker";

    public MaterialDateAndTimePickerFragment(IDateTimePicker? datePicker)
    {
        if (datePicker == null) return;
        
        m_datePicker = (datePicker as DateAndTimePicker)!;
    ...
    private class DismissListener : Object, IDialogInterfaceOnDismissListener
    {
        ...
        public DismissListener(DateAndTimePicker datePicker, MaterialDatePicker materialDatePicker)
        {
        ...
        public void OnDismiss(IDialogInterface? dialog)
        {
            ...
            if (long.TryParse(m_materialDatePicker.Selection?.ToString(), out var milliseconds))
            {
                ...
                m_datePicker.SelectedDateTime = dateFromJava;
            }
