...
public partial class Counter : Grid
{
    ...
    private readonly Label m_primaryLabel = new() {Style = Styles.GetLabelStyle(LabelStyle.Body200), HeightRequest = Sizes.GetSize(SizeName.size_5) };
    private readonly Label m_secondaryLabel = new() {Style = Styles.GetLabelStyle(LabelStyle.Body200), HeightRequest = Sizes.GetSize(SizeName.size_5) };
