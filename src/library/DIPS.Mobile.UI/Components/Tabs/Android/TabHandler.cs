...
public class TabHandler : ViewHandler<Tab, Google.Android.Material.Tabs.TabItem>
{
    ...
    protected void ConnectHandler(Google.Android.Material.Chip.Chip platformView)
    {
...
#pragma warning restore CA1422
    ...
    protected void DisconnectHandler(Google.Android.Material.Chip.Chip platformView)
    {
