...
namespace DIPS.Mobile.UI.Extensions
{
    ...
    public static class PropertyChangedExtensions
    {
        ...
        public static bool Set<TS>(this INotifyPropertyChanged propertyChangedImplementation, ref TS backingStore, TS value, PropertyChangedEventHandler? propertyChanged, [CallerMemberName] string propertyName = "")
        {
...
#pragma warning restore CS8604
        ...
        /// <remarks>This extension method does not set the event `sender` when notifying property changed. This has not proven to a problem when we created the extension, but be aware of it if you end up with something strange. Set <see cref="sender"/> if you need to make sure that we send the event sender</remarks>
        /// <returns>A boolean value to indicate that the property changed has been invoked</returns>
        public static bool RaiseWhenSet<TS>(this PropertyChangedEventHandler? propertyChanged, ref TS backingStore, TS value, object? sender = null, [CallerMemberName] string propertyName = "")
        {
